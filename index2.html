...
@media screen and (max-width: 990px) and (min-width: 748px)
{
    ...
    <div class="container aerna">
        ...
        <div class="row selectbox">
            ...
            <div class="col-sm-2 col-xs-6 form-group">
                      ...
                      <select class="form-control selectt" id="select_category" onchange="selectCategory(this.value)">
            ...
            <div class="col-sm-2 col-xs-6 form-group">
                      ...
                      <select class="form-control selectt" id="select_brand" onchange="selectBrand(this.value)">
            ...
            <div class="col-sm-2 col-xs-6">
                <p class="slider_head">Shop By Price</p>
                <?php
                $max_price = 0;
        ...
        */?>
        ...
        <div class="row projects abc">
            <!--loops Start here-->
                ...
                if($i<$num)
                {
                    $productID = $res[$i]['p_id'];
                ?>
                <a href="product.php?id=<?php echo $productID; ?>">
                    <!--/////////////////////////////////////////////////////////////////////////////////////-->
                    <div class="col-sm-3  card image-mobile" <?php if($i<3){ ?>style="margin-top:40px;" <?php } ?>>
                        <div class="row image" >
                             <?php
                                if ($res[$i]['image'] == '') {
                                    $path = '';
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h3 class="brand_name"><b><?php echo $res[$i]['product_title']; ?></b></h3>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                <p>Brand:<b> <?php echo $res[$i]['product_brand']; ?></b></p>
                            </div>
                        </div>
                        <div class="row">
                        <div class="col-sm-6 col-xs-6">
                            <p>Varient:<b><?php echo $res[$i]['product_size']; ?></b></p>
                        </div> 
                            <div class="col-sm-6 col-xs-6">
                                <p>Color:<b><?php echo $res[$i]['color']; ?></b></p>
                            </div>
                        </div>
                    </div>
                </a>
                ...
                <a href="product.php?id=<?php echo $productID; ?>">
                    <!--/////////////////////////////////////////////////////////////////////////////////////-->
                    <div class="col-sm-3 card image-mobile2" <?php if($i<3){ ?>style="margin-top:40px;" <?php } ?>>
                        <div class="row image" >
                             <?php
                                if ($res[$i]['image'] == '') {
                                    $path = '';
                        ...
                        <div class="row">
                        <div class="col-sm-6 col-xs-6">
                            <p>Varienty:<b><?php echo $res[$i]['product_size']; ?></b></p>
                        </div> 
                            <div class="col-sm-6 col-xs-6">
                                <p>Color:<b><?php echo $res[$i]['color']; ?></b></p>
                            </div>
                ...
                <a href="product.php?id=<?php echo $productID; ?>">
                    <!--/////////////////////////////////////////////////////////////////////////////////////-->
                    <div class="col-sm-3 card image-mobile3" <?php if($i<3){ ?>style="margin-top:40px;" <?php } ?>>
                        <div class="row image" >
                             <?php
                                if ($res[$i]['image'] == '') {
                                    $path = '';
        ...
        <?php
            ...
            {
                echo "<h4 class='no_data'>No data found.</h4>";
            }
            ?>
